...
class FrProductController extends Controller
{
    ...
    public function ProductByCategory($slug)
    {
        ...
        $products = Product::where('category_id', $category_by_product->id)->orderBy('id', 'asc')->where('status', 1)->paginate(9);
        $product_hot_news = Product::where('hot_new', 1)->where('status', 1)->limit(4)->get();
        $product_hot_deals = Product::where('hot_deal', 1)->where('status', 1)->limit(4)->get();
